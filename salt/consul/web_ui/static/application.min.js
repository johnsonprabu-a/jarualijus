...
window.App=Ember.Application.create({rootElement:"#app",currentPath:""}),Ember.Application.initializer({name:"settings",initialize:function(t,e){e.set("settings",App.Settings.create()),void 0===App.get("settings.token")&&App.set("settings.token","")}}),App.Router.map(function(){this.resource("dc",{path:"/:dc"},function(){this.resource("services",{path:"/services"},function(){this.route("show",{path:"/*name"})}),this.resource("nodes",{path:"/nodes"},function(){this.route("show",{path:"/:name"})}),this.resource("kv",{path:"/kv"},function(){this.route("index",{path:"/"}),this.route("show",{path:"/*key"}),this.route("edit",{path:"/*key/edit"})}),this.resource("acls",{path:"/acls"},function(){this.route("show",{path:"/:id"})}),this.route("aclsdisabled",{path:"/aclsdisabled"}),this.route("unauthorized",{path:"/unauthorized"})}),this.route("index",{path:"/"}),this.resource("settings",{path:"/settings"})});App.Service=Ember.Object.extend({failingChecks:function(){if(void 0!==this.get("ChecksCritical"))return this.get("ChecksCritical")+this.get("ChecksWarning");var e=this.get("Checks");return e.filterBy("Status","critical").get("length")+e.filterBy("Status","warning").get("length")}.property("Checks"),passingChecks:function(){return void 0!==this.get("ChecksPassing")?this.get("ChecksPassing"):this.get("Checks").filterBy("Status","passing").get("length")}.property("Checks"),checkMessage:function(){return this.get("hasFailingChecks")===!1?this.get("passingChecks")+" passing":this.get("failingChecks")+" failing"}.property("Checks"),nodes:function(){return this.get("Nodes")}.property("Nodes"),hasFailingChecks:Ember.computed.gt("failingChecks",0),filterKey:Ember.computed.alias("Name")}),App.Node=Ember.Object.extend({failingChecks:function(){return this.get("Checks").reduce(function(e,t){var r=Ember.get(t,"Status");return"critical"===r||"warning"===r?e+1:e},0)}.property("Checks"),passingChecks:function(){return this.get("Checks").filterBy("Status","passing").get("length")}.property("Checks"),checkMessage:function(){return this.get("hasFailingChecks")===!1?this.get("passingChecks")+" passing":this.get("failingChecks")+" failing"}.property("Checks"),hasFailingChecks:Ember.computed.gt("failingChecks",0),numServices:Ember.computed.alias("Services.length"),services:Ember.computed.alias("Services"),filterKey:Ember.computed.alias("Node")}),App.Key=Ember.Object.extend(Ember.Validations.Mixin,{validations:{Key:{presence:!0}},validateJson:!1,keyValid:Ember.computed.empty("errors.Key"),valueValid:Ember.computed.empty("errors.Value"),keyWithoutParent:function(){return this.get("Key").replace(this.get("parentKey"),"")}.property("Key"),isFolder:function(){return void 0===this.get("Key")?!1:"/"===this.get("Key").slice(-1)}.property("Key"),isLocked:function(){return this.get("Session")?!0:!1}.property("Session"),linkToRoute:function(){return"/"===this.get("Key").slice(-1)?"kv.show":"kv.edit"}.property("Key"),valueDecoded:function(e,t){return arguments.length>1?(this.set("Value",t),t):null===this.get("Value")?"":(Base64.extendString&&Base64.extendString(),this.get("Value").fromBase64())}.property("Value"),isValidJson:function(){var e;try{window.atob(this.get("Value")),e=this.get("valueDecoded")}catch(t){e=this.get("Value")}try{return JSON.parse(e),!0}catch(t){return!1}}.property("Value"),keyParts:function(){var e=this.get("Key");return"/"==e.slice(-1)&&(e=e.substring(0,e.length-1)),e.split("/")}.property("Key"),parentKey:function(){var e=this.get("keyParts").toArray();return e.pop(),e.join("/")+"/"}.property("Key"),grandParentKey:function(){var e=this.get("keyParts").toArray();return e.pop(),e.pop(),e.join("/")+"/"}.property("Key")}),App.Acl=Ember.Object.extend({isNotAnon:function(){return"anonymous"===this.get("ID")?!1:!0}.property("ID")}),App.Settings=Ember.Object.extend({unknownProperty:function(e){return localStorage[e]},setUnknownProperty:function(e,t){return Ember.isNone(t)?delete localStorage[e]:localStorage[e]=t,this.notifyPropertyChange(e),t},clear:function(){this.beginPropertyChanges();for(var e=0,t=localStorage.length;t>e;e++)this.set(localStorage.key(e));localStorage.clear(),this.endPropertyChanges()}});function distance(e,t){e=e.Coord,t=t.Coord;for(var n=0,o=0;o<e.Vec.length;o++){var r=e.Vec[o]-t.Vec[o];n+=r*r}var s=Math.sqrt(n)+e.Height+t.Height,i=s+e.Adjustment+t.Adjustment;return i>0&&(s=i),Math.round(1e5*s)/100}function formatUrl(e,t,n){return null==n&&(n=""),e.indexOf("?")>0?(e=e+"&dc="+t,e=e+"&token="+n):(e=e+"?dc="+t,e=e+"&token="+n),e}App.BaseRoute=Ember.Route.extend({rootKey:"",condensedView:!1,queryParams:{filter:{replace:!0}},getParentAndGrandparent:function(e){var t=this.rootKey,n=this.rootKey,o=e.split("/");return o.length>0&&(o.pop(),t=o.join("/")+"/"),o.length>1&&(o.pop(),n=o.join("/")+"/"),{parent:t,grandParent:n,isRoot:"/"===t}},removeDuplicateKeys:function(e,t){return e.forEach(function(n,o){n.get("Key")==t&&e.splice(o,1)}),e},actions:{linkToKey:function(e){"/"==e?this.transitionTo("kv.show",""):"/"===e.slice(-1)||e===this.rootKey?this.transitionTo("kv.show",e):this.transitionTo("kv.edit",e)}}}),App.IndexRoute=App.BaseRoute.extend({model:function(){return Ember.$.getJSON(consulHost+"/v1/catalog/datacenters").then(function(e){return e})},afterModel:function(e){1===e.get("length")&&this.transitionTo("services",e[0])}}),App.DcRoute=App.BaseRoute.extend({model:function(e){var t=App.get("settings.token");return Ember.RSVP.hash({dc:e.dc,dcs:Ember.$.getJSON(consulHost+"/v1/catalog/datacenters"),nodes:Ember.$.getJSON(formatUrl(consulHost+"/v1/internal/ui/nodes",e.dc,t)).then(function(e){var t=[];return e.map(function(e){t.push(App.Node.create(e))}),t}),coordinates:Ember.$.getJSON(formatUrl(consulHost+"/v1/coordinate/nodes",e.dc,t)).then(function(e){return e})})},setupController:function(e,t){e.set("content",t.dc),e.set("nodes",t.nodes),e.set("dcs",t.dcs),e.set("coordinates",t.coordinates),e.set("isDropdownVisible",!1)}}),App.KvIndexRoute=App.BaseRoute.extend({beforeModel:function(){this.transitionTo("kv.show",this.rootKey)}}),App.KvShowRoute=App.BaseRoute.extend({model:function(e){var t=e.key,n=this.modelFor("dc").dc,o=App.get("settings.token");return Ember.RSVP.hash({key:t,keys:Ember.$.getJSON(formatUrl(consulHost+"/v1/kv/"+t+"?keys&seperator=/",n,o)).then(function(e){var t=[];return e.map(function(e){t.push(App.Key.create({Key:e}))}),t})})},setupController:function(e,t){var n=t.key,o=this.getParentAndGrandparent(n);t.keys=this.removeDuplicateKeys(t.keys,t.key),e.set("content",t.keys),e.set("parentKey",o.parent),e.set("grandParentKey",o.grandParent),e.set("isRoot",o.isRoot),e.set("newKey",App.Key.create()),e.set("rootKey",this.rootKey)}}),App.KvEditRoute=App.BaseRoute.extend({model:function(e){var t=e.key,n=this.modelFor("dc").dc,o=this.getParentAndGrandparent(t),r=App.get("settings.token");return Ember.RSVP.hash({dc:n,token:r,key:Ember.$.getJSON(formatUrl(consulHost+"/v1/kv/"+t,n,r)).then(function(e){return App.Key.create().setProperties(e[0])}),keys:keysPromise=Ember.$.getJSON(formatUrl(consulHost+"/v1/kv/"+o.parent+"?keys&seperator=/",n,r)).then(function(e){var t=[];return e.map(function(e){t.push(App.Key.create({Key:e}))}),t})})},afterModel:function(e){return e.key.get("isLocked")?Ember.$.getJSON(formatUrl(consulHost+"/v1/session/info/"+e.key.Session,e.dc,e.token)).then(function(t){return e.session=t[0],e}):e},setupController:function(e,t){var n=t.key,o=this.getParentAndGrandparent(n.get("Key"));t.keys=this.removeDuplicateKeys(t.keys,o.parent),e.set("content",t.key),e.set("parentKey",o.parent),e.set("grandParentKey",o.grandParent),e.set("isRoot",o.isRoot),e.set("siblings",t.keys),e.set("rootKey",this.rootKey),e.set("session",t.session)}}),App.ServicesRoute=App.BaseRoute.extend({model:function(){var e=this.modelFor("dc").dc,t=App.get("settings.token");return Ember.$.getJSON(formatUrl(consulHost+"/v1/internal/ui/services",e,t)).then(function(e){var t=[];return e.map(function(e){t.push(App.Service.create(e))}),t})},setupController:function(e,t){e.set("services",t)}}),App.ServicesShowRoute=App.BaseRoute.extend({model:function(e){var t=this.modelFor("dc").dc,n=App.get("settings.token");return Ember.$.getJSON(formatUrl(consulHost+"/v1/health/service/"+e.name,t,n)).then(function(e){var t=[];return e.map(function(e){t.push(App.Node.create(e))}),t})},setupController:function(e,t){var n=[];t.map(function(e){null!==e.Service.Tags&&(n=n.concat(e.Service.Tags))}),n=n.filter(function(e){return void 0!==e}),n=n.uniq().join(", "),e.set("content",t),e.set("tags",n)}}),App.NodesShowRoute=App.BaseRoute.extend({model:function(e){var t=this.modelFor("dc"),n=App.get("settings.token"),o=999999999,r=-999999999,s=0,i=[];t.coordinates.forEach(function(n){e.name==n.Node&&(t.coordinates.forEach(function(e){if(n.Node!=e.Node){var t=distance(n,e);i.push({node:e.Node,distance:t}),s+=t,o>t&&(o=t),t>r&&(r=t)}}),i.sort(function(e,t){return e.distance-t.distance}))});var a,c=i.length,u=Math.floor(c/2);return c>0?a=c%2?i[u].distance:(i[u-1].distance+i[u].distance)/2:(a=0,o=0,r=0),Ember.RSVP.hash({dc:t.dc,token:n,tomography:{distances:i,n:i.length,min:parseInt(100*o)/100,median:parseInt(100*a)/100,max:parseInt(100*r)/100},node:Ember.$.getJSON(formatUrl(consulHost+"/v1/internal/ui/node/"+e.name,t.dc,n)).then(function(e){return App.Node.create(e)})})},afterModel:function(e){return Ember.$.getJSON(formatUrl(consulHost+"/v1/session/node/"+e.node.Node,e.dc,e.token)).then(function(t){return e.sessions=t,e})},setupController:function(e,t){e.set("content",t.node),e.set("sessions",t.sessions),e.set("tomography",t.tomography)}}),App.NodesRoute=App.BaseRoute.extend({model:function(){var e=this.modelFor("dc").dc,t=App.get("settings.token");return Ember.$.getJSON(formatUrl(consulHost+"/v1/internal/ui/nodes",e,t)).then(function(e){var t=[];return e.map(function(e){t.push(App.Node.create(e))}),t})},setupController:function(e,t){e.set("nodes",t)}}),App.AclsRoute=App.BaseRoute.extend({model:function(){var e=this.modelFor("dc").dc,t=App.get("settings.token");return Ember.$.getJSON(formatUrl(consulHost+"/v1/acl/list",e,t)).then(function(e){var t=[];return e.map(function(e){"anonymous"===e.ID?t.unshift(App.Acl.create(e)):t.push(App.Acl.create(e))}),t})},actions:{error:function(e){return e&&401===e.status?this.transitionTo("dc.aclsdisabled"):e&&403===e.status&&this.transitionTo("dc.unauthorized"),!0}},setupController:function(e,t){e.set("acls",t),e.set("newAcl",App.Acl.create())}}),App.AclsShowRoute=App.BaseRoute.extend({model:function(e){var t=this.modelFor("dc").dc,n=App.get("settings.token");return Ember.RSVP.hash({dc:t,acl:Ember.$.getJSON(formatUrl(consulHost+"/v1/acl/info/"+e.id,t,n)).then(function(e){return App.Acl.create(e[0])})})},setupController:function(e,t){e.set("content",t.acl)}}),App.SettingsRoute=App.BaseRoute.extend({model:function(){return App.get("settings")}});App.ApplicationController=Ember.ObjectController.extend({updateCurrentPath:function(){App.set("currentPath",this.get("currentPath"))}.observes("currentPath")}),App.DcController=Ember.Controller.extend({needs:["application"],isDropdownVisible:!1,datacenter:Ember.computed.alias("content"),totalChecksFailing:function(){return this.get("nodes").reduce(function(e,t){return e+t.get("failingChecks")},0)}.property("nodes"),totalChecksPassing:function(){return this.get("nodes").reduce(function(e,t){return e+t.get("passingChecks")},0)}.property("nodes"),checkMessage:function(){var e=this.get("totalChecksFailing"),t=this.get("totalChecksPassing");return this.get("hasFailingChecks")===!0?e+" failing":t+" passing"}.property("nodes"),checkStatus:function(){return this.get("hasFailingChecks")===!0?"failing":"passing"}.property("nodes"),hasFailingChecks:Ember.computed.gt("totalChecksFailing",0),actions:{toggle:function(){this.toggleProperty("isDropdownVisible")},hideDrop:function(){this.set("isDropdownVisible",!1)}}}),KvBaseController=Ember.ObjectController.extend({getParentKeyRoute:function(){return this.get(this.get("isRoot")?"rootKey":"parentKey")},transitionToNearestParent:function(e){var t=this,n=t.get("rootKey"),s=t.get("dc").get("datacenter"),o=App.get("settings.token");Ember.$.ajax({url:formatUrl(consulHost+"/v1/kv/"+e+"?keys",s,o),type:"GET"}).then(function(){t.transitionToRoute("kv.show",e)}).fail(function(e){404===e.status&&t.transitionToRoute("kv.show",n)}),t.set("isLoading",!1)}}),App.KvShowController=KvBaseController.extend(Ember.Validations.Mixin,{needs:["dc"],dc:Ember.computed.alias("controllers.dc"),isLoading:!1,actions:{createKey:function(){this.set("isLoading",!0);var e=this,t=e.get("newKey"),n=e.get("parentKey"),s=(e.get("grandParentKey"),e.get("dc").get("datacenter")),o=App.get("settings.token");void 0!==n&&"/"!==n&&t.set("Key",n+t.get("Key")),Ember.$.ajax({url:formatUrl(consulHost+"/v1/kv/"+t.get("Key"),s,o),type:"PUT",data:t.get("Value")}).then(function(){t.get("isFolder")===!0?e.transitionToRoute("kv.show",t.get("Key")):e.transitionToRoute("kv.edit",t.get("Key")),e.set("isLoading",!1)}).fail(function(t){e.set("errorMessage","Received error while processing: "+t.statusText)})},deleteFolder:function(){this.set("isLoading",!0);var e=this,t=e.get("dc").get("datacenter"),n=e.get("grandParentKey"),s=App.get("settings.token");window.confirm("Are you sure you want to delete this folder?")&&Ember.$.ajax({url:formatUrl(consulHost+"/v1/kv/"+e.get("parentKey")+"?recurse",t,s),type:"DELETE"}).then(function(){e.transitionToNearestParent(n)}).fail(function(t){e.set("errorMessage","Received error while processing: "+t.statusText)})}}}),App.KvEditController=KvBaseController.extend({isLoading:!1,needs:["dc"],dc:Ember.computed.alias("controllers.dc"),actions:{updateKey:function(){this.set("isLoading",!0);var e=this.get("dc").get("datacenter"),t=this.get("model"),n=this,s=App.get("settings.token");Ember.$.ajax({url:formatUrl(consulHost+"/v1/kv/"+t.get("Key"),e,s),type:"PUT",data:t.get("valueDecoded")}).then(function(){n.set("isLoading",!1)}).fail(function(e){n.set("errorMessage","Received error while processing: "+e.statusText)})},cancelEdit:function(){this.set("isLoading",!0),this.transitionToRoute("kv.show",this.getParentKeyRoute()),this.set("isLoading",!1)},deleteKey:function(){this.set("isLoading",!0);var e=this,t=e.get("dc").get("datacenter"),n=e.get("model"),s=e.getParentKeyRoute(),o=App.get("settings.token");Ember.$.ajax({url:formatUrl(consulHost+"/v1/kv/"+n.get("Key"),t,o),type:"DELETE"}).then(function(){e.transitionToNearestParent(s)}).fail(function(t){e.set("errorMessage","Received error while processing: "+t.statusText)})}}}),ItemBaseController=Ember.ArrayController.extend({needs:["dc","application"],queryParams:["filter","status","condensed"],dc:Ember.computed.alias("controllers.dc"),condensed:!0,hasExpanded:!0,filterText:"Filter by name",filter:"",status:"any status",statuses:["any status","passing","failing"],isShowingItem:function(){var e=this.get("controllers.application.currentPath");return"dc.nodes.show"===e||"dc.services.show"===e}.property("controllers.application.currentPath"),filteredContent:function(){var e=this.get("filter"),t=this.get("status"),n=this.get("items").filter(function(t){return t.get("filterKey").toLowerCase().match(e.toLowerCase())});switch(t){case"passing":return n.filterBy("hasFailingChecks",!1);case"failing":return n.filterBy("hasFailingChecks",!0);default:return n}}.property("filter","status","items.@each"),actions:{toggleCondensed:function(){this.toggleProperty("condensed")}}}),App.NodesShowController=Ember.ObjectController.extend({needs:["dc","nodes"],dc:Ember.computed.alias("controllers.dc"),actions:{invalidateSession:function(e){this.set("isLoading",!0);var t=this,n=t.get("model"),s=t.get("dc").get("datacenter"),o=App.get("settings.token");window.confirm("Are you sure you want to invalidate this session?")&&Ember.$.ajax({url:formatUrl(consulHost+"/v1/session/destroy/"+e,s,o),type:"PUT"}).then(function(){return Ember.$.getJSON(formatUrl(consulHost+"/v1/session/node/"+n.Node,s,o)).then(function(e){t.set("sessions",e)})}).fail(function(e){t.set("errorMessage","Received error while processing: "+e.statusText)})}}}),App.NodesController=ItemBaseController.extend({items:Ember.computed.alias("nodes")}),App.ServicesController=ItemBaseController.extend({items:Ember.computed.alias("services")}),App.AclsController=Ember.ArrayController.extend({needs:["dc","application"],queryParams:["filter"],filterText:"Filter by name or ID",searchBar:!0,newAclButton:!0,types:["client","management"],dc:Ember.computed.alias("controllers.dc"),items:Ember.computed.alias("acls"),filter:"",isShowingItem:function(){var e=this.get("controllers.application.currentPath");return"dc.acls.show"===e}.property("controllers.application.currentPath"),filteredContent:function(){var e=this.get("filter"),t=this.get("items").filter(function(t){var n=t.get("Name").toLowerCase().match(e.toLowerCase());return null!==n?n:t.get("ID").toLowerCase().match(e.toLowerCase())});return t}.property("filter","items.@each"),actions:{createAcl:function(){this.set("isLoading",!0);var e=this,t=e.get("newAcl"),n=e.get("dc").get("datacenter"),s=App.get("settings.token");Ember.$.ajax({url:formatUrl(consulHost+"/v1/acl/create",n,s),type:"PUT",data:JSON.stringify(t)}).then(function(t){e.transitionToRoute("acls.show",t.ID),Ember.$.getJSON(formatUrl(consulHost+"/v1/acl/list",n,s)).then(function(t){var n=[];t.map(function(e){n.push(App.Acl.create(e))}),e.set("items",n)}),e.set("isLoading",!1)}).fail(function(t){notify("Received error while creating ACL: "+t.statusText,8e3),e.set("isLoading",!1)})}}}),App.AclsShowController=Ember.ObjectController.extend({needs:["dc","acls"],dc:Ember.computed.alias("controllers.dc"),isLoading:!1,types:["client","management"],actions:{set:function(){this.set("isLoading",!0);{var e=this,t=e.get("model");e.get("dc").get("datacenter")}if(window.confirm("Are you sure you want to use this token for your session?")){{App.set("settings.token",t.ID)}e.transitionToRoute("services"),this.set("isLoading",!1),notify("Now using token: "+t.ID,3e3)}},clone:function(){this.set("isLoading",!0);var e=this,t=e.get("model"),n=e.get("dc").get("datacenter"),s=App.get("settings.token");e.transitionToRoute("services"),Ember.$.ajax({url:formatUrl(consulHost+"/v1/acl/clone/"+t.ID,n,s),type:"PUT"}).then(function(t){e.transitionToRoute("acls.show",t.ID),e.set("isLoading",!1),notify("Successfully cloned token",4e3)}).fail(function(t){e.set("errorMessage","Received error while processing: "+t.statusText),e.set("isLoading",!1)})},"delete":function(){this.set("isLoading",!0);var e=this,t=e.get("model"),n=e.get("dc").get("datacenter"),s=App.get("settings.token");window.confirm("Are you sure you want to delete this token?")&&Ember.$.ajax({url:formatUrl(consulHost+"/v1/acl/destroy/"+t.ID,n,s),type:"PUT"}).then(function(){Ember.$.getJSON(formatUrl(consulHost+"/v1/acl/list",n,s)).then(function(t){objs=[],t.map(function(e){"anonymous"===e.ID?objs.unshift(App.Acl.create(e)):objs.push(App.Acl.create(e))}),e.get("controllers.acls").set("acls",objs)}).then(function(){e.transitionToRoute("acls"),e.set("isLoading",!1),notify("ACL deleted successfully",3e3)})}).fail(function(t){e.set("errorMessage","Received error while processing: "+t.statusText),e.set("isLoading",!1)})},updateAcl:function(){this.set("isLoading",!0);var e=this,t=e.get("model"),n=e.get("dc").get("datacenter"),s=App.get("settings.token");Ember.$.ajax({url:formatUrl(consulHost+"/v1/acl/update",n,s),type:"PUT",data:JSON.stringify(t)}).then(function(){e.set("isLoading",!1),notify("ACL updated successfully",3e3)}).fail(function(t){notify("Received error while updating ACL: "+t.statusText,8e3),e.set("isLoading",!1)})}}}),App.SettingsController=Ember.ObjectController.extend({actions:{reset:function(){this.set("isLoading",!0);var e=this;window.confirm("Are your sure you want to reset your settings?")&&(localStorage.clear(),e.set("content",App.Settings.create()),App.set("settings.token",""),notify("Settings reset",3e3),this.set("isLoading",!1))},close:function(){this.transitionToRoute("index")}}}),App.ErrorController=Ember.ObjectController.extend({actions:{resetToken:function(){App.set("settings.token",""),this.transitionToRoute("settings")},backHome:function(){this.transitionToRoute("index")}}});App.DcView=Ember.View.extend({templateName:"dc",classNames:"dropdowns",click:function(e){$(e.target).is(".dropdowns")&&$("ul.dropdown-menu").hide()}}),App.ItemView=Ember.View.extend({templateName:"item"}),App.ServicesView=Ember.View.extend({templateName:"services"}),App.ServicesShowView=Ember.View.extend({templateName:"service"}),App.ServicesLoadingView=Ember.View.extend({templateName:"item/loading"}),App.NodesView=Ember.View.extend({templateName:"nodes"}),App.NodesShowView=Ember.View.extend({templateName:"node"}),App.NodesLoadingView=Ember.View.extend({templateName:"item/loading"}),App.KvListView=Ember.View.extend({templateName:"kv"}),App.ActionBarView=Ember.View.extend({templateName:"actionbar"}),App.AclView=Ember.View.extend({templateName:"acls"}),App.AclsShowView=Ember.View.extend({templateName:"acl"}),App.SettingsView=Ember.View.extend({templateName:"settings"});function notify(e,a){void 0!==window.notifications&&window.notifications.length>0&&$(window.notifications).each(function(e,a){a.dismiss()});var s=new NotificationFx({message:"<p>"+e+"</p>",layout:"growl",effect:"slide",type:"notice",ttl:a});s.show(),window.notifications=[],window.notifications.push(s)}function tomographyMouseOver(e){var a=e.getAttribute("data-node")+" - "+e.getAttribute("data-distance")+"ms";document.getElementById("tomography-node-info").innerHTML=a}Ember.Handlebars.helper("panelBar",function(e){var a;return a="passing"==e?"bg-green":"bg-orange",new Handlebars.SafeString('<div class="panel-bar '+a+'"></div>')}),Ember.Handlebars.helper("listBar",function(e){var a;return a="passing"==e?"bg-green":"bg-orange",new Handlebars.SafeString('<div class="list-bar-horizontal '+a+'"></div>')}),Ember.Handlebars.helper("sessionName",function(e){var a;return a=""===e.Name?"<span>"+Handlebars.Utils.escapeExpression(e.ID)+"</span>":"<span>"+Handlebars.Utils.escapeExpression(e.Name)+"</span> <small>"+Handlebars.Utils.escapeExpression(e.ID)+"</small>",new Handlebars.SafeString(a)}),Ember.Handlebars.helper("sessionMeta",function(e){var a='<div class="metadata">'+Handlebars.Utils.escapeExpression(e.Behavior)+" behavior</div>";return""!==e.TTL&&(a=a+'<div class="metadata">, '+Handlebars.Utils.escapeExpression(e.TTL)+" TTL</div>"),new Handlebars.SafeString(a)}),Ember.Handlebars.helper("aclName",function(e,a){return""===e?a:new Handlebars.SafeString(Handlebars.Utils.escapeExpression(e)+' <small class="pull-right no-case">'+Handlebars.Utils.escapeExpression(a)+"</small>")}),Ember.Handlebars.helper("formatRules",function(e){return""===e?"No rules defined":e}),Ember.Handlebars.helper("limit",function(e,a){return e.length>a?e.substring(0,a)+"...":e}),Ember.Handlebars.helper("serviceTagMessage",function(e){return null===e?"No tags":void 0}),Ember.Handlebars.helper("tomographyGraph",function(e,a){var s=-999999999;e.distances.forEach(function(e){e.distance>s&&(s=e.distance)});var n=a/2-8,r='      <svg width="'+a+'" height="'+a+'">        <g class="tomography" transform="translate('+a/2+", "+a/2+')">          <g>            <circle class="background" r="'+n+'"/>            <circle class="axis" r="'+.25*n+'"/>            <circle class="axis" r="'+.5*n+'"/>            <circle class="axis" r="'+.75*n+'"/>            <circle class="border" r="'+n+'"/>          </g>          <g class="lines">',t=e.distances,i=t.length;if(e.n>360){var l=360/e.n;t=t.filter(function(e,a){return 0==a||a==i-1||Math.random()<l}),i=t.length}return t.forEach(function(e,a){r+='            <line transform="rotate('+360*a/i+')" y2="'+-n*(e.distance/s)+'" data-node="'+e.node+'" data-distance="'+e.distance+'" onmouseover="tomographyMouseOver(this);"/>'}),r+='          </g>          <g class="labels">            <circle class="point" r="5"/>            <g class="tick" transform="translate(0, '+n*-.25+')">              <line x2="70"/>              <text x="75" y="0" dy=".32em">'+(s>0?parseInt(25*s)/100:0)+'ms</text>            </g>            <g class="tick" transform="translate(0, '+n*-.5+')">              <line x2="70"/>              <text x="75" y="0" dy=".32em">'+(s>0?parseInt(50*s)/100:0)+'ms</text>            </g>            <g class="tick" transform="translate(0, '+n*-.75+')">              <line x2="70"/>              <text x="75" y="0" dy=".32em">'+(s>0?parseInt(75*s)/100:0)+'ms</text>            </g>            <g class="tick" transform="translate(0, '+-1*n+')">              <line x2="70"/>              <text x="75" y="0" dy=".32em">'+(s>0?parseInt(100*s)/100:0)+"ms</text>            </g>          </g>        </g>      </svg>",new Handlebars.SafeString(r)});